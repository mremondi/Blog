...
SET PATH=%PATH%;D:\home\site\deployments\tools\r\ruby-2.4.0-x64-mingw32\bin
...
if not exist r md r
cd r
if exist ruby-2.4.0-x64-mingw32 goto end

echo No Ruby, need to get it!

REM Get Ruby and Rails
REM 64bit
curl -o ruby224.zip -L https://bintray.com/artifact/download/oneclick/rubyinstaller/ruby-2.4.0-x64-mingw32.7z?direct
...
REM Setup DevKit
call ruby DevKit\dk.rb install

REM Update Gem223 until someone fixes the Ruby Windows installer https://github.com/oneclick/rubyinstaller/issues/261
curl -L -o update.gem https://github.com/rubygems/rubygems/releases/download/v2.4.0/rubygems-update-2.4.0.gem
